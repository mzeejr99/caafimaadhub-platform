...
router.get('/sms-logs', requireRole('ADMIN', 'SUPER_ADMIN'), (req, res, next) => notificationController.getSmsLogs(req, res, next));
router.post('/sms-broadcast', requireRole('ADMIN', 'SUPER_ADMIN'), (req, res, next) => notificationController.sendSmsBroadcast(req, res, next));
router.get('/sms-stats', requireRole('ADMIN', 'SUPER_ADMIN'), (req, res, next) => notificationController.getSmsStats(req, res, next));
