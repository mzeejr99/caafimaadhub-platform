...
router.put('/:id/accept', (req, res, next) => taskController.acceptTask(req, res, next));
router.put('/:id/start', (req, res, next) => taskController.startTask(req, res, next));
router.put('/:id/complete', (req, res, next) => taskController.completeTask(req, res, next));
router.put('/:id/reject', (req, res, next) => taskController.rejectTask(req, res, next));
