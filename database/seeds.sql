...
-- 8. Authentic Users (ONLY Super Administrator)
...
('tx-02', 'item-rutf-07', 'STOCK_IN', 500, 500, NULL, 'loc-srcs-wh', 'PO-UNICEF-NUT-2026', 'usr-superadmin-01', 'Consignment of PlumpyNut received for malnutrition outreach'),
('tx-03', 'item-coartem-13', 'STOCK_IN', 1650, 1650, NULL, 'loc-kis-store', 'PO-MOH-MAL-2026', 'usr-superadmin-01', 'Stock in of Coartem pediatric dispersible blisters');
...
('em-01', 'EMR-2026-0001', 'DISEASE_OUTBREAK', 'CRITICAL', 'Cluster of 14 children presenting with acute watery diarrhea (AWD) and rapid dehydration following heavy seasonal flooding.', 14, 'reg-hiran', 'dist-beledweyne', 'Koshin Village riverside', 4.7380, 45.2050, 'COMMUNITY', 'usr-superadmin-01', 'Hassan Omar Geedi', '+252 61 5666666', 'INVESTIGATING', 'Rapid response cholera/AWD team dispatched with ORS kits, zinc, and Aquatabs from Beledweyne Hospital.'),
('em-02', 'EMR-2026-0002', 'DISEASE_OUTBREAK', 'HIGH', 'Suspected measles cluster with fever and maculopapular rash among 9 un-vaccinated children in IDP settlement.', 9, 'reg-banadir', 'dist-daynile', 'Daynile IDP Section 3', 2.0820, 45.2750, 'PUBLIC', 'usr-superadmin-01', 'Asha Mohamed Weheliye', '+252 61 5777771', 'INVESTIGATING', 'Mobile immunization team queued for supplementary measles-rubella ring vaccination.');
...
('notif-01', 'usr-superadmin-01', 'Nidaamka CaafimaadHub Waa Diyaar', 'Ku soo dhowow madasha CaafimaadHub! Waxaad tahay Super Administrator.', 'SYSTEM_ALERT', '/admin/dashboard', 0),
('notif-02', 'usr-superadmin-01', 'Digniin Degdeg ah: Beledweyne AWD Outbreak', 'Waxaa la soo gudbiyey 14 kiis oo looga shakisan yahay AWD deegaanka Koshin Village.', 'EMERGENCY_ALERT', '/admin/emergencies', 0);
